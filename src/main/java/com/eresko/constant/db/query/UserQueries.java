...
public class UserQueries {
    ...
    //language=SQL
    public static final String SQL_ADD_USER = "INSERT INTO users (name, surname, email, password, mailings) VALUES (?,?,?,?,?)";
    //language=SQL
    public static final String SQL_FIND_USER_BY_EMAIL_AND_PASSWORD = "SELECT * FROM users WHERE email=? and password=?";
    //language=SQL
    public static final String SQL_UPDATE_USER = "UPDATE users SET name=?, surname=?, email=?, password=?, mailings=?, active=?, role=?  WHERE user_id=?";
    //language=SQL
